...
class EmpChatDetailScreen extends StatefulWidget {
  final String chatId;
  final String otherUserId;
  final String otherUserName;

  const EmpChatDetailScreen({
    Key? key,
  ...
  @override
  State<EmpChatDetailScreen> createState() => _EmpChatDetailScreenState();
}

class _EmpChatDetailScreenState extends State<EmpChatDetailScreen> with WidgetsBindingObserver {
