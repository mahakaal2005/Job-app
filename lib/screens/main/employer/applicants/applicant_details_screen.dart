...
class _ApplicantDetailsScreenState extends State<ApplicantDetailsScreen> {
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      print('   Resume Preview URL from applicant data: ${resumePreviewUrl ?? 'Not found'}');
      ...
      if ((resumeUrl == null || resumeUrl.isEmpty) && 
        ...
        if (userData.exists) {
          ...
          print('   Resume URL from users_specific: ${resumeUrl ?? 'Not found'}');
          print('   Resume Preview URL from users_specific: ${resumePreviewUrl ?? 'Not found'}');
        } else {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: _buildSection('Contact Information', Icons.contact_mail_outlined, [
              _buildInfoRow(
                'Email',
              ...
              _buildInfoRow(
                ...
                Icons.location_on_outlined,
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: _buildSection('Application Details', Icons.description_outlined, [
              _buildInfoRow(
                'Experience',
                ...
                Icons.work_outline,
                  ...
                  if (widget.applicant['applicantSkills'] != null &&
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20),
                      child: _buildSection('Skills', Icons.psychology_outlined, [
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children:
                  ...
                  if (widget.applicant['whyJoin'] != null &&
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20),
                      child: _buildSection('Why They Want to Join', Icons.lightbulb_outline, [
                        Text(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            widget.applicant['cvFileName'] ?? 'Resume.pdf',
                                            style: const TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w600,
                                              color: Color(0xFF0D0140),
